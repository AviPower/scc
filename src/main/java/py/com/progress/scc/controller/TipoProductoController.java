...
import py.com.progress.scc.util.JsfUtil;
import py.com.progress.scc.util.JsfUtil.PersistAction;
import py.com.progress.scc.service.TipoProductoFacade;
...
public class TipoProductoController implements Serializable {
    ...
    @EJB
    private py.com.progress.scc.service.TipoProductoFacade ejbFacade;
